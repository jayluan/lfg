    ...
    def finalize_options(self):
        ...
        if 'HOME' in os.environ:
            ...
            if os.path.exists(rc):
                self.announce('Using PyPI registration from %s' % rc)
                ...
                if not self.repository:
                    self.repository = config.get('server-registration', 'repository')
                if not self.username:
                    self.username = config.get('server-registration', 'username')
                if not self.password:
                    self.password = config.get('server-registration', 'password')
        if not self.repository:
