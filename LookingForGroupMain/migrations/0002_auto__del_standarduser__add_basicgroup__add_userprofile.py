...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'LookingForGroupMain_basicgroup', (
            ...
            ('users', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['LookingForGroupMain.UserProfile'], unique=True)),
    ...
    models = {
        u'LookingForGroupMain.basicgroup': {
            ...
            'users': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['LookingForGroupMain.UserProfile']", 'unique': 'True'})
        },
